...
#define VERSION 16 //software version number (without decimal point)
...
byte switches[3][6] = //the settings for the five switches in the vibrato/slide and register control panels
//instrument 0
...
//}
//Serial.println(switches[mode][CUSTOM]);
