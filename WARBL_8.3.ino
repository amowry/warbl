...
//#include <MemoryUsage.h> //can be used to show RAM statistics
#include <TimerOne.h> //for timer interupt for reading sensors at a regular interval
...
#define VERSION 83 //software version number
