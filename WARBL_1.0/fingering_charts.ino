...
const struct naf_explicit_entry naf_explicit[NAF_EXPLICIT_SIZE]PROGMEM  = {  //general fingering pattern for each MIDI note. In this case, the index (position from right) of the leftmost uncovered hole is used to determine the MIDI note. This way all other holes below that one are ignored.
{75}, //0000000 D#5
{74}, //0000001 D5
{74}, //0000010 D5
{73}, //0000011 C#5
...
const struct kaval_explicit_entry kaval_explicit[KAVAL_EXPLICIT_SIZE]PROGMEM  = {  //general fingering pattern for each MIDI note. In this case, the index (position from right) of the leftmost uncovered hole is used to determine the MIDI note. This way all other holes below that one are ignored.
