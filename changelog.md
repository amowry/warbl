...
- updated all documentation to refer to the WARBL software as "firmware" to help avoid confusion between teh firmware and installer packages, WARBL app, etc.
