...
- Notes are now sent as legato, simply meaning that NotOff events are sent immediately after NoteOn events, which signals to some MIDI synths that a legato effect is dersired.
