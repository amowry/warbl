...
#define VERSION 14 //software version number (without decimal point)
...
byte switches[3][5] = //the settings for the five switches in the vibrato/slide and register control panels
//instrument 0
...
//instrument 0                              //the actions are: 0 none, 1 send MIDI message, 2 change pitchbend mode, 3 instrument, 4 play/stop (bagless mode), 5 octave shift up, 6 octave shift down, 7 MIDI panic, 8 change register control mode, 9 drones on/off
